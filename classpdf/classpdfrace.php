...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->Cell(0, 20, 'Liste des Races', 0, 1, 'C');
    ...
    function TableHeader() {
        ...
        $this->Cell(40, 10, 'ID Race', 1, 0, 'C', true); // Fond activé avec `true`
    ...
    function TableRow($idrace, $librace, $alternate) {
        ...
        $this->Cell(40, 10, $idrace, 1, 0, 'C', true); // Utilisation du fond
        $this->Cell(100, 10, $librace, 1, 0, 'C', true);
        $this->Ln();
    }
}

...
class Cavaliers {
    ...
    public function Modifier($id, $nc, $pc, $dnc, $nl, $po, $nr, $pr, $rr,
                            $vr, $cpr, $tr, $emr, $pw, $assu, $idga){
        $con = connexionPDO();
        $data = [
            ':nc' => $nc,
            ':pc' => $pc,
    ...
    public function CavaliersAjt($nomcava, $prenomcava, $datenacava, $numlic, $photo, $nomresp, $prenomresp,

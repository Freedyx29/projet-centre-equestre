...
<div class="collapse navbar-collapse justify-content-center" id="navbarCollapse">
    <div class="navbar-nav p-4 p-lg-0">
        <a href="index.html" class="nav-item nav-link active me-2" style="font-size: 15px !important;">Accueil</a>
        <a href="about.html" class="nav-item nav-link me-3" style="font-size: 15px !important; white-space: nowrap;">À propos</a>
        <a href="service.html" class="nav-item nav-link me-3" style="font-size: 15px !important;">Cavaliers</a>
        <a href="service.html" class="nav-item nav-link me-3" style="font-size: 15px !important;">Événements</a>
        <a href="service.html" class="nav-item nav-link me-3" style="font-size: 15px !important;">Cours</a>
        <a href="service.html" class="nav-item nav-link me-3" style="font-size: 15px !important;">Cavalerie</a>
        <a href="contact.html" class="nav-item nav-link" style="font-size: 15px !important;">Contact</a>
    </div>
</div>
            </div>

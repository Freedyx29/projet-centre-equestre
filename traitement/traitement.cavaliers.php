...
if (isset($_POST['ajouter'])) {
    ...
    $success = $ocavaliers->CavaliersAjt($nomcava, $prenomcava, $datenacava, $emailcava, $numlic,$nomresp, $prenomresp, $rueresp, $vilresp, $cpresp, $telresp,
...
if (isset($_POST['modifier'])) {
    ...
    $assurance = $_POST['assurance'];
    $idgalop = $_POST['idgalop'];
    $success = $ocavaliers->Modifier($idcava, $nomcava, $prenomcava, $datenacava, $emailcava, $numlic,

...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 wow fadeIn" data-wow-delay="0.1s">
        <div class="container-fluid">
            ...
            <!-- Centered logo -->
            <a href="index.html" class="navbar-brand d-flex justify-content-center position-absolute start-50 translate-middle-x" style="top: -10px;">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarCollapse">
                <div class="navbar-nav p-4 p-lg-0">
                    ...
                    <a href="propos.php" class="nav-item nav-link active me-3" style="font-size: 15px !important; white-space: nowrap;">À propos</a>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <p>Fondé en 2005, Equihorizon est né de la passion pour les chevaux et de l'envie de partager cette passion avec le plus grand nombre. Depuis, nous avons grandi et évolué, mais notre mission reste la même : offrir une expérience équestre de qualité à tous nos cavaliers.</p>
                    <h3>Nos Valeurs</h3>
                    <p>Chez Equihorizon, nous croyons en l'importance du bien-être animal et humain. Nous mettons un point d'honneur à offrir des soins de qualité à nos chevaux et à créer un environnement convivial et respectueux pour nos cavaliers.</p>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <p class="d-inline-block border rounded-pill py-1 px-4">Galerie</p>
                <h1>Découvrez Notre Centre Équestre</h1>
            </div>
            <div class="row g-3">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="rounded overflow-hidden">
                        <img class="img-fluid" src="../photos/1.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="rounded overflow-hidden">
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <p class="mb-4">Si vous avez des questions ou souhaitez réserver une séance, n'hésitez pas à nous contacter. Nous serons ravis de vous aider.</p>
